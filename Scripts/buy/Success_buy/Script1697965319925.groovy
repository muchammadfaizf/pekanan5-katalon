...
WebUI.setText(findTestObject('Beli/Information_submission/firstName'), 'Faiz')

WebUI.setText(findTestObject('Beli/Information_submission/lastName'), 'Rizal')

WebUI.setText(findTestObject('Beli/Information_submission/zipCode'), '68131')

WebUI.click(findTestObject('Beli/Information_submission/btn_continue'))

WebUI.click(findTestObject('Beli/Information_submission/btn_finish'))

def text = WebUI.getText(findTestObject('Beli/Information_submission/txt_successBuy'))
WebUI.verifyMatch(text, 'Thank you for your order!', false)